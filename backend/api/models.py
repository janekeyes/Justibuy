...
class Clothing(models.Model):
    ...
    image_keypoints = models.ImageField(upload_to='keypoints/', null=True, blank=True)

    def save(self, *args, **kwargs):
        super().save(*args, **kwargs)

        if self.image and not self.image_keypoints:
            ...
            if is_success:
                ...
                self.image_keypoints.save(f'kp_{self.image.name}', ContentFile(io_buf.read()), save=False)
